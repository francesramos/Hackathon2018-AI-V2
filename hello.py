...
# !!!!!!!!!!!!!!!!!!!! MUST TEST OR PROGRAM WILL CRASH !!!!!!!!!!!!!!!!!!!
print("testing model: ", classifier.predict(sc.transform([[281,18.3,-65.9]])))
print("Model Loaded")
...
def home():
    ...
    if request.method == 'POST':
        ...
        graph_2_y = classifier.predict(sc.transform([[user_time,latitude,longitude]]))
        print(graph_2_y)

        graph_2_y = graph_2_y[0]
        # print(graph_2_x)
        graph_2_y = np.array2string(graph_2_y, separator=', ')
        print(graph_2_y)
